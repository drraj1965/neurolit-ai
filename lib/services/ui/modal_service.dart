        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text('${article.displayIdentifierLabel}: ${article.displayIdentifierValue}'),
              const SizedBox(height: 8),
              Text('Source: ${article.displaySource}'),
              const SizedBox(height: 8),
        ...
        actions: [
          ...
          if (article.link.trim().isNotEmpty)
            TextButton(
              ...
              child: Text(article.openLinkLabel),
            ),
          if (onDownloadFullText != null)
            TextButton(
              ...
              child: Text(article.fullTextActionLabel),
            ),
          TextButton(
