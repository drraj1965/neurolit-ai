...
import '../services/mode_workspace_service.dart';
  ...
  List<Article> get pagedArticles {
    ...
    final filtered = base.where((a) {
      ...
      if (postFilterTextAvailability == 'abstract') {
        ...
        matchText =
            a.isFree || a.isPMC || a.hasFullText || a.pdfUrl.trim().isNotEmpty;
      }
    ...
    return SearchSection(
      ...
      onModeChanged: (mode) {
        setState(() {
          ...
          savedCollections = const [];
          recentSearches = const [];
          dateFilter = '1y';
          customRange = null;
          textAvailability = 'any';
          articleType = 'any';
          postFilterTextAvailability = 'any';
          postFilterArticleType = 'any';
          autoExpand = false;
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () async {
              final folder = await workspaceService.getModeRoot(literatureMode);
