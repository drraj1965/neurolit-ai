...
LaymanPanel(
  ...
  onGeneratePpt: (json) async {
    await generatePptFromSlides(json);
  },
),
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              children: [
                SingleChildScrollView(
                  child: buildTopSection(), // 🔥 your existing UI reused
                ),
